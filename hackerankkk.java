public class MudWalls {
    ...
    public static int maxHeight(int[] stickPositions, int[] stickHeights) {
        ...
        for (int i=0; i<n-1; i++) {
            if (stickPositions[i]<stickPositions[i+1]-1) {int heightDiff =  Math.abs(stickHeights[i+1] - stickHeights[i]);
	 ...
	 public static void main(String[] args) throws FileNotFoundException {
        System.setIn(new FileInputStream(System.getProperty("user.home") + "/" + "in9.txt"));Scanner scanner = new Scanner(System.in);
